...
const Contact = () => {
  return (
    <section className="p-8 md:p-16 bg-bg-start text-text-primary text-center">
      <h2 className="text-4xl md:text-5xl mb-12 font-bold text-primary-accent">Contact Me</h2>
      <div className="flex flex-col gap-8 max-w-xl mx-auto bg-bg-end p-8 md:p-12
                      rounded-xl shadow-2xl border border-border-color">

        <div className="mb-4">
          <h3 className="text-2xl font-semibold text-text-primary mb-2">Phone:</h3>
          <a href="tel:+959263038660" className="text-xl text-text-secondary hover:text-hover-glow transition-colors duration-200">
            [cite_start]+959 2630 38 660 [cite: 10]
          </a>
        </div>

        <div className="mb-4">
          <h3 className="text-2xl font-semibold text-text-primary mb-2">Email:</h3>
          <a href="mailto:winminthant.gwin@gmail.com" className="text-xl text-text-secondary hover:text-hover-glow transition-colors duration-200">
            [cite_start]winminthant.gwin@gmail.com [cite: 13]
          </a>
        </div>

        <div>
          <h3 className="text-2xl font-semibold text-text-primary mb-2">Address:</h3>
          <p className="text-xl text-text-secondary m-0">
            [cite_start]Hlaing, Yangon [cite: 15]
          </p>
        </div>
