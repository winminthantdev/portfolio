...
const Footer = () => {
  ...
  return (
    <footer className="bg-bg-end p-8 text-center text-text-secondary border-t border-border-color mt-auto">
      <div className="mb-4">
        <a href="#" className="text-text-secondary mx-4 text-lg hover:text-primary-accent transition-colors duration-200">
          Home
        </a>
        <a href="#" className="text-text-secondary mx-4 text-lg hover:text-primary-accent transition-colors duration-200">
          About
